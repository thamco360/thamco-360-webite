...
export const services = [
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    description: 'Professional 360° virtual tours in Bengaluru: on-site capture, hand-refined stitching, and a walkable tour published to Google and embedded on your website. From ₹5,000.',
...
<p>Any business whose space helps customers decide. We have written detailed guides for <a href="/blog/360-virtual-tour-resorts-hotels-bangalore/">resorts and hotels</a>, <a href="/blog/virtual-tour-coworking-office-spaces-bangalore/">co-working spaces</a>, <a href="/blog/360-virtual-tour-restaurants-cafes-bangalore/">restaurants and cafés</a>, <a href="/blog/virtual-tour-hospitals-dental-clinics-bangalore/">clinics and hospitals</a>, <a href="/blog/360-virtual-tour-real-estate-bangalore/">real estate</a>, <a href="/blog/virtual-tour-schools-colleges-bangalore/">schools and colleges</a>, <a href="/blog/360-virtual-tour-wedding-event-venues-bangalore/">wedding venues</a> and <a href="/blog/virtual-tour-gyms-salons-showrooms-bangalore/">gyms, salons and showrooms</a>.</p>`,
      },
      {
        ...
        h2: 'Pricing',
        html: `
<p>Thamco360 virtual tour packages generally range from <strong>₹5,000 to ₹35,000+</strong>. The price depends on the size of the space, the number of scan points needed, and whether you want extras such as a website embed or custom 3D features. Send us your space details on WhatsApp for an exact quote.</p>`,
      },
    ],
    faqs: [
      { q: 'How much does a 360° virtual tour cost in Bengaluru?', a: 'Thamco360 packages generally range from ₹5,000 to ₹35,000+, depending on the size of the space, the number of scan points and any extras such as a website embed or custom 3D features.' },
  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    title: 'Google Street View Photography for Businesses in Bengaluru | Thamco360',
    description: 'Google Trusted 360° photography in Bengaluru: we capture your premises and publish a walk-in view to your Google Business Profile, so customers see inside from Google Maps and Search.',
...
<p>We will be straight with you: Google does not publish a ranking boost for 360° imagery, and nobody can promise one. What a tour reliably does is make your profile more complete and more convincing, which helps customers choose you once they find you. For the full picture, read our guide on <a href="${GMB}">how a Google Business Profile tour helps Bangalore businesses</a>.</p>`,
      },
      {
        ...
        h2: 'Pricing',
        html: `
<p>Google Business Profile tours fall within Thamco360’s <strong>₹5,000 to ₹35,000+</strong> range, depending on the size of your premises and the number of areas covered. Most shops, cafés and clinics are at the lower end.</p>`,
      },
    ],
    faqs: [
      ...
      { q: 'How much does Google 360° photography cost in Bengaluru?', a: 'Thamco360 packages generally range from ₹5,000 to ₹35,000+, depending on the size of the premises and the number of areas covered.' },
    ],
